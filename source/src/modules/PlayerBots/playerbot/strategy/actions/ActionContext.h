...
namespace ai
{
    ...
    public:
        ActionContext()
        {
            ...
            creators["pull approach"] = [](PlayerbotAI* ai) { return new PullApproachAction(ai); };
            creators["pull hold"] = [](PlayerbotAI* ai) { return new PullHoldAction(ai); };
            ...
            creators["companion revive"] = [](PlayerbotAI* ai) { return new CompanionReviveAction(ai); };
