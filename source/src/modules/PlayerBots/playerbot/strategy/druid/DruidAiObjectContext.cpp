    ...
    namespace druid
    {
        ...
        public:
            TriggerFactoryInternal()
            {
                ...
                // "is the roar missing from my target", so a bear can keep it up
                // on ONE mob. Same generic DebuffTrigger the other classes use
                // for their maintenance debuffs.
                creators["demoralizing roar"] = [](PlayerbotAI* ai) { return new DebuffTrigger(ai, "demoralizing roar"); };
