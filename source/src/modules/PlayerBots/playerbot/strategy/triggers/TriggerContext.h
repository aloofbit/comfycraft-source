...
namespace ai
{
    ...
    public:
        TriggerContext()
        {
            ...
            creators["pull prepare"] = [](PlayerbotAI* ai) { return new PullPrepareTrigger(ai); };
            creators["pull stage"] = [](PlayerbotAI* ai) { return new PullStageTrigger(ai); };
            creators["pull approach"] = [](PlayerbotAI* ai) { return new PullApproachTrigger(ai); };
            creators["pull fire"] = [](PlayerbotAI* ai) { return new PullFireTrigger(ai); };
            creators["pull return"] = [](PlayerbotAI* ai) { return new PullReturnTrigger(ai); };
            creators["pull finish"] = [](PlayerbotAI* ai) { return new PullFinishTrigger(ai); };
            creators["pull hold"] = [](PlayerbotAI* ai) { return new PullHoldTrigger(ai); };
            ...
            creators["needs food"] = [](PlayerbotAI* ai) { return new NeedsFoodTrigger(ai); };
            ...
            creators["party member attacked"] = [](PlayerbotAI* ai) { return new PartyMemberAttackedTrigger(ai); };
            ...
            creators["companion revive"] = [](PlayerbotAI* ai) { return new CompanionReviveTrigger(ai); };
