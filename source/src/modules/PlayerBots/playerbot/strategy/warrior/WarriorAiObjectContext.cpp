    ...
    namespace warrior
    {
        ...
        public:
            AiObjectContextInternal()
            {
                ...
                creators["taunt on party attacker"] = [](PlayerbotAI* ai) { return new CastTauntOnPartyAttackerAction(ai); };
                creators["sunder armor on party attacker"] = [](PlayerbotAI* ai) { return new CastSunderArmorOnPartyAttackerAction(ai); };
