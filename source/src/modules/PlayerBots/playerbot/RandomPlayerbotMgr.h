...
public:
    ...
    public:
        ...
        // Drop everything this value store remembers about a character low guid,
        // in the database and in the cache. Call it when the character is
        // DELETED - guids are reused, and specNo/specLink never expire.
        void ForgetBot(uint32 guid);
    ...
    public:
        // Drop a guid from the real-player map, before the character it names
        // stops existing. See PlayerbotMgr::OnBotDeleted.
        void ForgetTrackedPlayer(uint32 guid);
