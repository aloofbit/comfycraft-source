...
void AddScripts()
{
    // housing -- the instance script for map 169, see src/game/Housing
    AddSC_player_house();
    AddSC_house_portal();
    AddSC_house_control();
    ...
    AddSC_item_house_furniture();
    AddSC_item_invasion_sigil();
    AddSC_npc_house_furniture_shop();
    AddSC_npc_companion_spike();
