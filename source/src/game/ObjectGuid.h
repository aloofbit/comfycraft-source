...
enum TypeMask
{
    ...
    // OURS. A bot NPC is a PLAYER wearing UNIT_NPC_FLAGS, so a quest
    // handler that used to mean "a creature or a gameobject" has to mean
    // this instead. docs/ai/content/playerbot-npcs.md.
    TYPEMASK_CREATURE_GAMEOBJECT_OR_PLAYER = TYPEMASK_UNIT | TYPEMASK_GAMEOBJECT | TYPEMASK_PLAYER,
