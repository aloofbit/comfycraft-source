...
void WorldSession::HandleTextEmoteOpcode(WorldPacket & recv_data)
{
    ...
    // A HOUSE CRITTER NOTICES BEING PATTED. The line above is the seam this
    // wants and cannot use: ReceiveEmote needs our own AI class bound through
    // creature_template.script_name, and house critters are stock Turtle rows.
    // Same free-function seam as the gameobject click, and housing owns the
    // guid test.
    if (guid.IsCreature())
        HouseCritterEmote(GetPlayer(), guid.GetCounter(), textEmote);
}
