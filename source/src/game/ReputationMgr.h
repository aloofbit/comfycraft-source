...
class ReputationMgr
{
    ...
    private:                                                // internal helper functions
        void Initialize();
        // Factionless: lift the reputations a race is born at war with to peace.
        // Runs at the end of LoadFromDB, so it sees the stored values and can
        // correct them. No-op unless Factionless.Enable is on.
        void ApplyFactionlessPeace();
